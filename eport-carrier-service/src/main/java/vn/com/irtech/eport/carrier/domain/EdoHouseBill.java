...
public class EdoHouseBill extends BaseEntity {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("id", getId())
				.append("logisticGroupId", getLogisticGroupId()).append("logisticAccountId", getLogisticAccountId())
				.append("edoId", getEdoId()).append("billOfLading", getBillOfLading())
				.append("orderNumber", getOrderNumber()).append("masterBillNo", getMasterBillNo())
				.append("consignee", getConsignee()).append("houseBillNo", getHouseBillNo())
				.append("houseBillNo2", getHouseBillNo2()).append("consignee2", getConsignee2())
				.append("containerNumber", getContainerNumber()).append("sztp", getSztp()).append("opr", getOpr())
				.append("vessel", getVessel()).append("voyNo", getVoyNo()).append("taxCode", getConsignee2TaxCode())
				.append("releaseFlg", getReleaseFlg()).append("createBy", getCreateBy())
