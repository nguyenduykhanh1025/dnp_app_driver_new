//const PREFIX = ctx + "om/booking/shipments"; 
//const HIST_PREFIX = ctx + "om/controlling";

const PREFIX = ctx + "system/checkCont"; //om/booking
//const HIST_PREFIX = ctx + "system/controllingCheck";//om/controlling
...
function getRequestConfigIcon(frozenStatus) {
...
function configHandson() {
  config = {
    ...
    colWidths: [23, 21, 21, 150, 130, 100, 150, 100, 100, 100, 80, 80, 100, 100, 100, 100],
    filter: "true",
    columns: [
      {
        data: "active",
...
function isDisableBtnRequestConfirm() {
	  ...
	  for (let i = 0; i < sourceData.length; ++i) {
	     if(sourceData[i].frozenStatus == CONT_SPECIAL_STATUS.YES){ 
	    	 result = true;
	     } 
	  }
