const PREFIX = ctx + "duty/loading-cargo";
...
function configHandsond() {
  config = {
    ...
    colWidths: [23, 21, 21, 135, 130, 100, 100, 150, 120, 120, 120, 100, 200, 100, 80, 150, 150, 100, 120, 150, 100, 130, 130, 130, 200],
    filter: "true",
    columns: [
      {
        data: "active",
...
function changeDate(rowIndex, date) {
  hot.setDataAtCell(rowIndex, 9, date)
}
