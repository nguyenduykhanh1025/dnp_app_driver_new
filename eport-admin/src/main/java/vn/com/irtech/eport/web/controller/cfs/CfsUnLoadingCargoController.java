package vn.com.irtech.eport.web.controller.cfs;
...
@Controller
@RequestMapping("/cfs/unloading-cargo")
public class CfsUnLoadingCargoController extends AdminBaseController {
	protected final Logger logger = LoggerFactory.getLogger(CfsUnLoadingCargoController.class);
	private final String PREFIX = "cfs/unloadingCargo";
