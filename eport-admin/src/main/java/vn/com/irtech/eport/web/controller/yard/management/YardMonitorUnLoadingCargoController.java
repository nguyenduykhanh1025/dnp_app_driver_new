...
@Controller
@RequestMapping("/yard/monitor/unloading-cargo")
public class YardMonitorUnLoadingCargoController extends AdminBaseController {
	protected final Logger logger = LoggerFactory.getLogger(YardMonitorUnLoadingCargoController.class);
	private final String PREFIX = "yard/unloadingCargo";
