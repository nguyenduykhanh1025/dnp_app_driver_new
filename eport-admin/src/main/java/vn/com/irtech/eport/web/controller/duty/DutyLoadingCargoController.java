...
@Controller
@RequestMapping("/duty/loading-cargo")
public class DutyLoadingCargoController extends AdminBaseController {
	protected final Logger logger = LoggerFactory.getLogger(DutyLoadingCargoController.class);
	private final String PREFIX = "duty/loadingCargo";
