package vn.com.irtech.eport.web.controller.duty;
...
@Controller
@RequestMapping("/duty/unloading-cargo")
public class DutyUnLoadingCargoController extends AdminBaseController {
	protected final Logger logger = LoggerFactory.getLogger(DutyUnLoadingCargoController.class);
	private final String PREFIX = "duty/unloadingCargo";
