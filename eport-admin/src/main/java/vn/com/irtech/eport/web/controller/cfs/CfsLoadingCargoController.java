...
@Controller
@RequestMapping("/cfs/loading-cargo")
public class CfsLoadingCargoController extends AdminBaseController {
	protected final Logger logger = LoggerFactory.getLogger(CfsLoadingCargoController.class);
	private final String PREFIX = "cfs/loadingCargo";
