                            ...
                            <View style={styles.Line}>
                                <View style={{
                                    ...
                                    <View style={{
                                        ...
                                        <Text style={[styles.TextLabel]}>Số Container</Text>
                                    ...
                                    <View style={{
                                        ...
                                        <Text style={[styles.TextLabel, { width: ws(30) }]}>K/T</Text>
                            ...
                            <View style={styles.Line}>
                                <View style={{
                                    ...
                                    <View style={{
                                        ...
                                        <Text style={[styles.TextLabel]}>Trọng lượng</Text>
                                    ...
                                    <View style={{
                                        ...
                                        <Text style={[styles.TextLabel, { width: ws(30) }]}>L/H</Text>
                                        <Text style={[styles.TextValue1, { color: Colors.subColor }]}>
                                            {data.cargoType}
                                        </Text>
                                    </View>
