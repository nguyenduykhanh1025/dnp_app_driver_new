...
public class ContainerHistoryEntity {
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("historySeq", getHistorySeq())
            .append("cntrUid", getCntrUid())
            .append("vslCd", getVslCd())
            .append("callYear", getCallYear())
            .append("callSeq", getCallSeq())
            .append("cntrNo", getCntrNo())
            .append("staffCd", getStaffCd())
            .append("updateTime", getUpdateTime())
            .append("tableName", getTableName())
            .append("cntrSeq", getCntrSeq())
            .append("dataField", getDataField())
            .append("oldValue", getOldValue())
            .append("newValue", getNewValue())
            .append("cntrState", getCntrSeq())
            .append("modeChangeType", getModeChangeType())
            .toString();
    }
}
