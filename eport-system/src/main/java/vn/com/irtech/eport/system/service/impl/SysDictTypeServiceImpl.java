...
import vn.com.irtech.eport.system.mapper.SysDictDataMapper;
import vn.com.irtech.eport.system.mapper.SysDictTypeMapper;
import vn.com.irtech.eport.system.service.ISysDictTypeService;
import vn.com.irtech.eport.system.utils.DictUtils;
...
public class SysDictTypeServiceImpl implements ISysDictTypeService
{
    ...
    public int deleteDictTypeByIds(String ids)
    {
        ...
        for (Long dictId : dictIds)
        {
            ...
            {
                throw new BusinessException(String.format("%1$s Assigned and cannot be deleted", dictType.getDictName()));
            }
        }
