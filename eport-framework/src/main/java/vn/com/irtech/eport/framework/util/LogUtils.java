...
public class LogUtils
{
    ...
    /**
     * Record access logs [username][jsessionid][ip][accept][UserAgent][url][params][Referer]
     *
     * @param request
     * @throws Exception
     */
    ...
    /**
     * Log exception error format [exception]
     *
     * @param message
     * @param e
     */
    ...
    /**
     * Log page errors Error log records [page/eception][username][statusCode][errorMessage][servletName][uri][exceptionName][ip][exception]
     *
     * @param request
     */
