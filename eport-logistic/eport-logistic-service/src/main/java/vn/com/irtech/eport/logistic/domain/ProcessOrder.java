...
public class ProcessOrder extends BaseEntity {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("id", getId())
				...
				.append("serviceType", getServiceType()).append("invoiceNo", getInvoiceNo())
				.append("payType", getPayType()).append("sztp", getSztp()).append("modee", getModee())
				.append("consignee", getConsignee()).append("truckCo", getTruckCo()).append("taxCode", getTaxCode())
				.append("blNo", getBlNo()).append("bookingNo", getBookingNo()).append("pickupDate", getPickupDate())
				.append("vessel", getVessel()).append("voyage", getVoyage()).append("beforeAfter", getBeforeAfter())
				.append("year", getYear()).append("contNumber", getContNumber()).append("status", getStatus())
				.append("result", getResult()).append("data", getData()).append("createBy", getCreateBy())
				.append("createTime", getCreateTime()).append("updateBy", getUpdateBy())
				.append("updateTime", getUpdateTime()).append("robotUuid", getRobotUuid())
				.append("ssrCode", getSsrCode()).append("sysUserId", getSysUserId())
				.append("postProcessId", getPostProcessId()).append("runnable", getRunnable())
				.append("orderNo", getOrderNo()).append("processData", getProcessData())
				.append("groupName", getGroupName()).append("paymentStatus", getPaymentStatus())
				.append("doStatus", getDoStatus()).append("logisticName", getLogisticName())
				.append("domesticFlg", getDomesticFlg()).append("bookingCreateMode", getBookingCreateMode())
				.append("bookingIndex", getBookingIndex()).append("fe", getFe()).append("opr", getOpr())
				.append("pol", getPol()).append("pod", getPod()).append("cargoType", getCargoType())
				.append("trucker", getTrucker()).append("msg", getMsg()).append("errorImagePath", getErrorImagePath())
				.append("holdFlg", getHoldFlg()).append("params", getParams()).toString();
	}
}
