...
public class ShipmentDetailServiceImpl implements IShipmentDetailService {
    ...
    @Transactional
    public List<QueueOrder> makeOrderReceiveContFull(List<ShipmentDetail> shipmentDetails, Shipment shipment,
            String isCredit) {
    ...
    public boolean checkCustomStatus(String customNumber) throws IOException {
        String uri = "http://192.168.0.36:8060/ACCIS-Web/rest/v1/eportcontroller/getCustomsStatus/?UserVoy=ALVE0319&CntrNo=WHSU2004506";
        // URI uri = new URI(uri);
