...
public interface ShipmentDetailMapper {
	 ...
	 * @return result
	 */
	public int deleteShipmentDetailByIds(@Param("shipmentId") Long shipmentId,
			@Param("shipmentDetailIds") String[] shipmentDetailIds, @Param("logisticGroupId") Long logisticGroupId);
	 ...
	 * @return Integer
	 */
	public Integer countNumberOfLegalCont(@Param("shipmentDetails") List<ShipmentDetail> shipmentDetails,
			@Param("logisticGroupId") Long logisticGroupId);
	 ...
	 */
	public List<PickupAssignForm> selectShipmentDetailForDriverShipmentAssign(@Param("shipmentId") Long shipmentId,
