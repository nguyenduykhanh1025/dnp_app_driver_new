...
public class SysLoginService
{
    ...
    public LogisticAccount login(String username, String password)
    {
...
//        }
    ...
    public void recordLoginInfo(LogisticAccount user)
    {
        user.setLoginIp(ShiroUtils.getIp());
        user.setLoginDate(DateUtils.getNowDate());
        logisticAccountService.updateLogisticAccount(user);
    }
}
