...
function transferOutToIn() {
    ...
    while (i < size) {
        if ($("#externalCheckbox" + externalTransport[i].id).prop("checked")) {
            ...
            var tableRow = '<tr id="transport'+ externalTransport[i].id +'"><td width="' + checkField + '"><input type="checkbox" id="internalCheckbox' + externalTransport[i].id +'" onclick="externalCheck()"/></td><td width="' + plateNumberField + '">' + externalTransport[i].plateNumber + '</td><td width="' + mobileNumberField + '">' + externalTransport[i].mobileNumber + '</td><td width="' + fullNameField + '">' + externalTransport[i].fullName + '</td></tr>';
