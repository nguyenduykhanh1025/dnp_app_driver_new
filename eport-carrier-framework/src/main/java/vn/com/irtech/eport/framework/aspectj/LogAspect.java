...
public class LogAspect {
	...
	protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult) {
		try {
			...
			if (currentUser != null) {
				operLog.setOperName(currentUser.getEmail());
				if (StringUtils.isNotNull(currentUser.getCarrierGroup())
						&& StringUtils.isNotEmpty(currentUser.getCarrierGroup().getGroupCode())) {
					operLog.setDeptName(currentUser.getCarrierGroup().getGroupCode());
				}
			}
