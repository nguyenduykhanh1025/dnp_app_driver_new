CREATE TABLE `otp_code` (
	...
	`shipment_detailIds` VARCHAR(255) NOT NULL COMMENT 'Shipment detailIds' COLLATE 'utf8_bin',
	`phone_number` varchar(13) NOT NULL COMMENT 'Phone number' COLLATE 'utf8_bin',
	`opt_code` int(11) NOT NULL COMMENT 'OTP CODE' COLLATE 'utf8_bin',
	...
	PRIMARY KEY (`id`)
) COMMENT='otp Code' COLLATE='utf8_bin' ENGINE=InnoDB;
