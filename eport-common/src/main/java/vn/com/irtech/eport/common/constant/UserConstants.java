...
public class UserConstants
{
    ...
    public static final String MST_PATTERN = "^[0-9]{10,15}$";
    public static final String IDENTIFY_NO_PATTERN = "^[0-9]{9,15}$";
    public static final String MOBILE_PHONE_PATTERN = "^[0-9]{10,11}$";
