...
public class EportUtils {
	...
	/**
	 * This method get a container Number, get rid the last number which is the
	 * check digit, generate the check digit and validate if is correct.
	 *
	 * @param containerNumber e.g. CSQU3054383
	 * @return True if the check digit is the same unless false
	 */
	public boolean verifyContainerNo(String containerNumber) {
		...
		// Get rid of the last number, the last number is the check digit where we want
		// to generated in order to validate.
